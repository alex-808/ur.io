...
exports.clientData =
    exports.state =
    exports.handleLeaveGame =
    exports.handleReset =
    exports.handleTokenHover =
    exports.handleTokenClick =
    exports.handleRollDice =
    exports.handleJoinGame =
    exports.handleNewGame =
        void 0;
...
var handleLeaveGame = function (client, server) {
    var _a;
    var roomID =
        (_a = clientData[client.id]) === null || _a === void 0
            ? void 0
            : _a.room;
    var room = server.sockets.adapter.rooms.get(roomID);
    client.leave(roomID);
...
var handleRollDice = function (client, server) {
    ...
    var game = state[roomID];
    var activePlayerID =
        (_a = game.activePlayer) === null || _a === void 0 ? void 0 : _a.id;
...
var handleTokenClick = function (client, server, tokenOwnerID, token) {
    ...
    if (!game.isMovePossible(tokenOwnerID, token) || tokenOwnerID !== playerID)
        return;
    if (token === constants.PLAYER_START) {
        token = game.activePlayer.tokens.findIndex(function (tokenPos) {
            return tokenPos === constants.PLAYER_START;
        });
    }
